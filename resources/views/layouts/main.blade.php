...
<head>
    ...
    <style>
        ...
        main { border: 1px solid #ddd; padding: 15px; margin: 10px 0; border-radius: 6px; }
...
<body>
    ...
    <footer style="background: #f5f5f5; padding: 10px; text-align: center; position: fixed; bottom: 0; left: 0; width: 100%;">
        <p>&copy; 2025 Praktikum Laravel - Holliyo Eben Haezer Thonak</p>
    </footer>
</body>
</html>
